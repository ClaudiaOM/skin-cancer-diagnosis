...
name_id_map = dict(zip([0,1,2,3],class_names ))
...
def save_and_show_heatmap(img_src_path, img_dst_path, model, last_conv_layer_name, preprocessing_function = None):
    # Prepare image
    ...
    print("Classes: ", name_id_map[y_classes[0]])
...
def heatmap(img_path, model, top_layer, preprocessing_function = None):
    h = save_and_show_heatmap(img_path,"cam.png", model, top_layer, preprocessing_function)
    return h
